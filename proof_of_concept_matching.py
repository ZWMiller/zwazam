...
track1 = WavFingerprint('test_wav/jazz_club.wav')
track2 = WavFingerprint('test_wav/Bust_This_Bust_That.wav')
...
print("Test is Track2")
print("Matches with Track2: ", test_hash_matches(test_hashes,track2.hashes))
print("Matches with Track1: ", test_hash_matches(test_hashes,track1.hashes))
